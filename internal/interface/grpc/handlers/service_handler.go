...
func (h *serviceHandler) RefundVHTLC(ctx context.Context, req *pb.RefundVHTLCRequest) (*pb.RefundVHTLCResponse, error) {
	...
	return &pb.RefundVHTLCResponse{RedeemTxid: redeemTxid}, nil
}
