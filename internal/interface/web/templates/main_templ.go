...
func runOnLoad() templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_runOnLoad_5a28`,
		Function: `function __templ_runOnLoad_5a28(){updateFiatValues()
  ...
  if (settings.Unit !== "sat") toggleUnit()
		...
		Call:       templ.SafeScript(`__templ_runOnLoad_5a28`),
		CallInline: templ.SafeScriptInline(`__templ_runOnLoad_5a28`),
	}
}
