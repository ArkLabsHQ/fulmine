...
func ReceiveQrCodeContent(bip21, encoded, sats string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 11, "</p></div></div><div class=\"flex flex-col md:flex-row justify-start gap-4 mt-10 mb-2\"><button class=\"bg-graybg md:w-32\" onclick=\"handleCopy(event)\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
