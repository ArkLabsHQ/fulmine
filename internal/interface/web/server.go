...
func NewService(
	appSvc *application.Service, stopCh chan struct{}, sentryEnabled bool, arkServer string,
) *service {
	...
	svc := &service{Engine: router, svc: appSvc, stopCh: stopCh, arkServer: arkServer}
