...
func checkLine(id, text string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `templates/pages/password.templ`, Line: 22, Col: 12}
		}
...
func SetPasswordContent() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<div class=\"p-3 flex flex-col justify-between h-screen\"><div id=\"setPassComponent\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("<p class=\"mt-16 mb-10\">Create a password that will be used to unlock your wallet.</p><p class=\"mb-2\">Password</p><div class=\"flex justify-between items-center gap-4 bg-graybg border-1 border-white/10 p-2 rounded w-full\"><div class=\"grow\"><input class=\"bg-graybg border-0 w-full\" name=\"password\" oninput=\"checkPass()\" type=\"password\"></div><p class=\"eyes\" onclick=\"toggleVisibility()\"><span>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</span></p></div><p class=\"mt-4 mb-2\">Repeat password</p><div class=\"flex justify-between items-center gap-4 bg-graybg border-1 border-white/10 p-2 rounded w-full\"><div class=\"grow\"><input class=\"bg-graybg border-0 w-full\" name=\"pconfirm\" oninput=\"checkPass()\" type=\"password\"></div><p class=\"eyes\" onclick=\"toggleVisibility()\"><span>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = EyeOpenIcon().Render(ctx, templ_7745c5c3_Buffer)
