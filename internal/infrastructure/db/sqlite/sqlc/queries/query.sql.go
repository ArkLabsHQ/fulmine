...
func (q *Queries) GetSwap(ctx context.Context, id string) (GetSwapRow, error) {
	...
	err := row.Scan(
		...
		&i.Vhtlc.NonInteractiveReceiverPkscript,
		&i.Vhtlc.NonInteractiveIntrospectorPubkey,
		&i.Vhtlc.NonInteractiveExtraPacket,
	)
	return i, err
}

const getVHTLC = `-- name: GetVHTLC :one
SELECT id, preimage_hash, sender, receiver, server, refund_locktime, unilateral_claim_delay_type, unilateral_claim_delay_value, unilateral_refund_delay_type, unilateral_refund_delay_value, unilateral_refund_without_receiver_delay_type, unilateral_refund_without_receiver_delay_value, non_interactive_receiver_pkscript, non_interactive_introspector_pubkey, non_interactive_extra_packet FROM vhtlc WHERE id = ?
`
...
func (q *Queries) GetVHTLC(ctx context.Context, id string) (Vhtlc, error) {
	...
	err := row.Scan(
		...
		&i.NonInteractiveReceiverPkscript,
		&i.NonInteractiveIntrospectorPubkey,
		&i.NonInteractiveExtraPacket,
	)
	return i, err
}
...
type InsertVHTLCParams struct {
	...
	NonInteractiveReceiverPkscript            sql.NullString
	NonInteractiveIntrospectorPubkey          sql.NullString
	NonInteractiveExtraPacket                 sql.NullString
}
...
func (q *Queries) InsertVHTLC(ctx context.Context, arg InsertVHTLCParams) error {
	_, err := q.db.ExecContext(ctx, insertVHTLC,
		...
		arg.NonInteractiveReceiverPkscript,
		arg.NonInteractiveIntrospectorPubkey,
		arg.NonInteractiveExtraPacket,
	)
	return err
}
...
SELECT id, preimage_hash, sender, receiver, server, refund_locktime, unilateral_claim_delay_type, unilateral_claim_delay_value, unilateral_refund_delay_type, unilateral_refund_delay_value, unilateral_refund_without_receiver_delay_type, unilateral_refund_without_receiver_delay_value, non_interactive_receiver_pkscript, non_interactive_introspector_pubkey, non_interactive_extra_packet FROM vhtlc
`
