...
const (
	...
	Service_GetVHTLCTransaction_FullMethodName        = "/fulmine.v1.Service/GetVHTLCTransaction"
...
type ServiceClient interface {
	...
	// GetVHTLCTransaction returns the fully signed ark transaction for a VHTLC,
	// whether the VHTLC is spent by a finalized or pending tx.
	GetVHTLCTransaction(ctx context.Context, in *GetVHTLCTransactionRequest, opts ...grpc.CallOption) (*GetVHTLCTransactionResponse, error)
...
func (c *serviceClient) GetVHTLCTransaction(ctx context.Context, in *GetVHTLCTransactionRequest, opts ...grpc.CallOption) (*GetVHTLCTransactionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetVHTLCTransactionResponse)
	err := c.cc.Invoke(ctx, Service_GetVHTLCTransaction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ServiceServer interface {
	...
	// GetVHTLCTransaction returns the fully signed ark transaction for a VHTLC,
	// whether the VHTLC is spent by a finalized or pending tx.
	GetVHTLCTransaction(context.Context, *GetVHTLCTransactionRequest) (*GetVHTLCTransactionResponse, error)
	// GetVirtualTxs returns the virtual transactions in hex format for the specified txids.
...
func (UnimplementedServiceServer) GetVHTLCTransaction(context.Context, *GetVHTLCTransactionRequest) (*GetVHTLCTransactionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetVHTLCTransaction not implemented")
}
...
func _Service_GetVHTLCTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetVHTLCTransactionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceServer).GetVHTLCTransaction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Service_GetVHTLCTransaction_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).GetVHTLCTransaction(ctx, req.(*GetVHTLCTransactionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Service_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetVHTLCTransaction",
			Handler:    _Service_GetVHTLCTransaction_Handler,
		},
		{
