...
require (
	...
	github.com/ark-network/ark/pkg/client-sdk v0.0.0-20241217135720-7e4cb82944d5
...
require (
	...
	github.com/ark-network/ark/api-spec v0.0.0-20241217135720-7e4cb82944d5 // indirect
