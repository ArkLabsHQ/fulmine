...
replace github.com/ark-network/ark/pkg/client-sdk => ../ark/pkg/client-sdk

replace github.com/ark-network/ark/common => ../ark/common

replace github.com/ark-network/ark/api-spec => ../ark/api-spec
