...
func (h *SwapHandler) refundVHTLC(
	...
	if withReceiver {
		res, err := h.boltzSvc.RefundSubmarine(
			swapId, boltz.RefundSwapRequest{Transaction: unsignedRefundTx,
		...
		boltzSignedRefundTx := res.Transaction
		boltzSignedCheckpointTx := res.Checkpoint
